package com.ohgiraffers.restapi.section04.hateos;
...
public class HateosTestController {
    ...
    public ResponseEntity<ResponseMessage> findAllUsers(){
        ...
        List<EntityModel<UserDTO>> userWithRel
                =users.stream().map(user->EntityModel.of(
                        user,
                linkTo(methodOn(HateosTestController.class).findUserByNo(user.getNo())).withSelfRel(),
                linkTo(methodOn(HateosTestController.class).findAllUsers()).withRel("users")
